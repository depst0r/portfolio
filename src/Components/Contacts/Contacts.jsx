...
import user from '../../Images/Contacts/user.png'
            ...
            <div className="contacts__columns">
                <div className="contacts__column">
                    <img src={user} alt='user' />
                        <Window className='window__contacts'>
                                <div className='window-code'>&gt; $ npm start</div>
                                <div className='window-code'>&gt; compiling...</div>
                                <div className='window-code'>&gt; contacts</div>
                                <div className='window-code'>&gt; 
                                    <a  href="https://github.com/depst0r" className="social__link"  target="blank">
                                    <svg className="icon" fill="currentColor" viewBox="0 0 24 24" width="22" height="22">
                                ...
                                <div className='window-code'>&gt; 
                                    <a href="https://www.linkedin.com/in/siarhey-pantsialeyenka-4537461a7/" className="social__link"  target="blank">
                                        <svg className="icon" fill="currentColor" viewBox="0 0 24 24" width="22" height="22">
                                    ...
                                    <div className='window-code'>&gt; 
                                    <a href="https://t.me/depstor_1" className="social__link"  target="blank">
                                    <svg className='icon' width="23" height="23" viewBox="0 0 24 24" fill="currentColor" width="22" height="22">
                ...
                <div className="contacts__column">
                    <span className="title-h5">
                        Available for exciting projects and full-time work.
                        I build production-ready web applications with React and TypeScript. Clean code, performance, 
                        and attention to detail are not just words — they're my standard.
                        Let's create something great together. Message me.
                    </span>
                </div>
            </div>
        </div>
